...
function ReplyContent({
  ...
  const handleSubmit = (event) => {
    ...
    axios
      ...
      .then((res) => {
        dispatch({ type: SET_REPLY_STATUS_1 });
        dispatch({ type: SET_COMMENT_REPLY_1, payload: res.data });
        dispatch({ type: CLEAR_COMMENT_REPLY_FORM_ERRORS_1 });
      ...
      .catch((err) => {
        ...
        // clear errors
        dispatch({
          type: SET_COMMENT_REPLY_FORM_ERRORS_1,
  ...
  return (
    <div className="bg-[#edebe6] p-1 sm:p-3 rounded-md">
      {/* meta section */}
